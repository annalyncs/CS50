...
a provided credit card number is valid
...
int main(void)
{
    ...
    //create array with each digit
    int number[count];

    //create an array with car number reversed
    ...
    //copy first array without first digit
    ...
    //access every other number and multiply by 2
    ...
    if (count == 13)
    {
      for (int i = 0; i < count; i++)
      {
          //mod 10 to get the last digit in the case the the number is 2 digits
          //divide by 10 to shift decimal point and get the next number
          //add them together
          //store value in v
          //keep repeating for loop; v holds previous value
